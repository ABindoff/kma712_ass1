...
ModelFinder [@kalyaanamoorthy2017modelfinder] was used to find the most likely tree from a maximum likelihood model fitted in IQ-Tree (v.1.6.10-Windows) [@nguyen2014iq]. Model robustness was estimated using a bootstrap procedure (UFBoot [@hoang2017ufboot2]).  
